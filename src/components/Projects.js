...
function Projects() {
    return (
        <div className="Projects">
            <ul>
                <li>
                <b>Twitter Ukraine Project</b> - clustered 10,000 tweets about the Russian-Ukrainian by performing different clustering methods on the MiniLM embeddings: k-means and HDBSCAN. Then it compares the coherence scores of the two different methods. Created using Python and utilizes libraries such as numpy, pandas, nltk, and scikit-learn.
                </li>
                <li>
